      ...
      generatePageNumbersHTML: function(args) {
        ...
        if (attributes.pageRange === null) {
          for (i = 1; i <= totalPage; i++) {
            if (i == currentPage) {
              html += '<li class="page-item ' + classPrefix + '-page J-paginationjs-page ' + activeClassName + '" data-num="' + i + '"><a class="page-link" href="#">' + i + '<\/a><\/li>';
            } else {
        ...
        if (rangeStart <= 3) {
          ...
          html += '<li class="page-item ' + classPrefix + '-ellipsis ' + disableClassName + '"><a class="page-link" href="#">' + ellipsisText + '<\/a><\/li>';
        }
      ...
      generateHTML: function(args) {
        ...
        if (showPrevious || showPageNumbers || showNext) {
          ...
          if (showPrevious) {
            if (currentPage <= 1) {
              if (!autoHidePrevious) {
                html += '<li class="page-item ' + classPrefix + '-prev ' + disableClassName + '"><a class="page-link" href="#">' + prevText + '<\/a><\/li>';
              }
            } else {
          ...
          if (showNext) {
            if (currentPage >= totalPage) {
              if (!autoHideNext) {
                html += '<li class="page-item ' + classPrefix + '-next ' + disableClassName + '"><a class="page-link" href="#">' + nextText + '<\/a><\/li>';
              }
            } else {
